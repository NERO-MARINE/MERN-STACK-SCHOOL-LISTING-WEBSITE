...
const Datatable = ({ columns }) => {
  ...
  const { apiData } = useFetch(`${URL}/${path}/`);
  ...
  return (
    ...
    <div className="datatable">
      ...
      <DataGrid
        ...
        columns={
          columns === userColumns ? columns.concat(actionColumn) : columns
        } //  deleting schools was causing an issue on the user side hence I did it this way. I only show the action column on the users page
        initialState={{
          pagination: {
